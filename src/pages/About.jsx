    ...
    <>
      ...
      >
        <h1 className="text-blue text-7xl font-title mx-8 sm:text-6xl sm:text-center">
          <span className="underline text-9xl text-peche ">A</span>
          BOUT ME
        </h1>
        <div className="grid grid-cols-3 gap-24 my-14 mx-8">
          <div className=" border-t border-blue text-justify font-body text-peche ">
            {" "}
            <span className="text-bold text-6xl text-blue "> Hi ! </span>
            My name is Nawël. I'm 26, and i live in Biarritz. I'm passionate by
          ...
          <div className=" border-t my-64 border-blue text-justify font-body text-peche ">
